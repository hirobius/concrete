export default function TermsPage() {
  return (
    <article className="container-page py-20 max-w-editorial prose-sm">
      <h1 className="text-h1">Terms of Sale</h1>
      ...
      <div className="mt-10 space-y-6 text-primary text-body">
        <section>
          <h2 className="text-h3 text-primary">1. The seller</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">2. Handmade variation</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">3. Pricing &amp; payment</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">4. Shipping &amp; risk of loss</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">5. Limitation of liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">6. Governing law</h2>
          <p>
