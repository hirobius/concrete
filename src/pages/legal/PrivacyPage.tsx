  ...
  return (
    <article className="container-page py-20 max-w-editorial">
      ...
      <div className="mt-10 space-y-6 text-primary text-body">
        <section>
          <h2 className="text-h3 text-primary">What we collect</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">How we use it</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">Sharing</h2>
          <p>
        ...
        <section>
          <h2 className="text-h3 text-primary">Cookies &amp; analytics</h2>
          <p>
